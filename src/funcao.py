...
fireboy_img = load_image(image_path, 'fireboy.png')
watergirl_img = load_image(image_path, 'watergirl.png')
...
fireboy_img = load_image(image_path, 'fireboy.png', 32, 32)
watergirl_img = load_image(image_path, 'watergirl.png', 32, 32)
